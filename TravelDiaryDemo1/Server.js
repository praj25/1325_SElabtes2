...
app.get('/displayComments',function(req,res){
	var arr = [];
	connection.query("SELECT comment_info.user_id,comment_id,trip_id,comment,date,first_name,last_name,profile_image from comment_info,personal_info where comment_info.user_id=personal_info.user_id",function(err,rows){
		if(err){
			console.log("ERROR in database: "+err);
		}
		else{
...
app.get('/getUserID',function(req,res){
	...
	var arr = [];
	var user_id=sessions.user_id;
	connection.query("SELECT * from personal_info where user_id="+user_id+"",function(err,rows){
		if(err){
			console.log("ERROR in database: "+err);
		}
		else{
